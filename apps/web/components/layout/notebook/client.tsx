...
export function NavbarLinkItem({
  ...
  return (
    <LinkItem
      item={item}
      className={cn(
        buttonVariants({ size: "sm", color: "ghost" }),
        "text-sm font-normal text-fd-muted-foreground transition-colors hover:text-fd-accent-foreground data-[active=true]:text-fd-primary",
        className,
      )}
      {...props}
    >
