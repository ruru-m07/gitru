...
function CommandDialogBackdrop({
  ...
  return (
    <CommandDialogPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-50 bg-black/32 backdrop-blur-[2px] transition-all duration-75 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
